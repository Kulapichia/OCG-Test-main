...
function updateProxyPlaceholder() {
	...
	switch (apiType) {
		case 'openai':
			proxyInput.placeholder = 'https://openai.chiangma.com/v1';
			geminiOnlyElements.forEach(el => el.classList.add('hidden'));
			break;
		case 'claude':
			proxyInput.placeholder = 'https://claudet.chiangma.com/v1';
			geminiOnlyElements.forEach(el => el.classList.add('hidden'));
			break;
		case 'gemini':
			proxyInput.placeholder = 'https://geminit.chiangma.com/v1beta';
